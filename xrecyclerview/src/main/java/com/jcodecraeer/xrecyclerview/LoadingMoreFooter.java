...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView(){
        ...
        progressView.setIndicatorColor(Color.WHITE);//0xffafaeae
        ...
        mText.setTextColor(Color.WHITE);//0xffafaeae
...
//        if(style == ProgressStyle.SysProgress){//progressBarStyle
//            ProgressBar progressBar = new ProgressBar(getContext(), null, android.R.attr.progressBarStyle);
//            progressBar.setProgressDrawable(new ClipDrawable(new ColorDrawable(Color.WHITE), Gravity.LEFT, ClipDrawable.HORIZONTAL));
