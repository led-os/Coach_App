...
import com.hzdc.picture.shopping.utils.CommonUtils;
...
public class ImageWatcher extends FrameLayout implements GestureDetector.OnGestureListener, ViewPager.OnPageChangeListener {
    ...
    public static final int STATE_ENTER_DISPLAYING = 3; //查看大图
    public static final int STATE_EXIT_HIDING = 4;//退出大图
    ...
    protected int mErrorImageRes = R.drawable.ic_default_image; // 图片加载失败站位图
    protected int mSaveImageRes = R.drawable.pic_load_icon;
    private int mBackImageRes = R.drawable.ic_white_back;
    protected int mStatusBarHeight; // 状态栏高度  0 无状态栏
    ...
    private backSaveCallback backSaveCallback;
    ...
    public void setBackSaveCallback(backSaveCallback sIC){
        backSaveCallback = sIC;
    }
    ...
    public interface backSaveCallback {
        void save();
        void back();
    }
    ...
    public class DefaultIndexProvider implements IndexProvider {
        ...
        public View initialView(Context context) {
            ...
            lpCurrentIdx.gravity = Gravity.CENTER;
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        if (hadTapMessage) {
            ...
            if (saveView != null && x > saveView.getLeft() && x < saveView.getRight() && y > saveView.getTop() && y < saveView.getBottom()) {
                if (backSaveCallback != null) {
                    Log.e("wrg", "------uri" +getDisplayingUri());
                    backSaveCallback.save();
                }
            } else {
                mHandler.sendEmptyMessageDelayed(SINGLE_TAP_UP_CONFIRMED, 350);
            }

//            else if (backView != null && x > backView.getLeft() && x < backView.getRight() && y > backView.getTop() && y < backView.getBottom()) {
//                if (backSaveCallback != null) {
//                    backSaveCallback.back();
//                }
//            }
        }
        return false;
    ...
    class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (backView == null) {
                backView = new ImageView(container.getContext());
                backView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
                LayoutParams lpBottomInParent = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                lpBottomInParent.gravity = Gravity.TOP | Gravity.START;
                lpBottomInParent.height = CommonUtils.dp2px(container.getContext(), 48);
                lpBottomInParent.width = CommonUtils.dp2px(container.getContext(), 48);
                lpBottomInParent.setMargins(CommonUtils.dp2px(container.getContext(), 10),
                        CommonUtils.dp2px(container.getContext(), 24),CommonUtils.dp2px(container.getContext(), 10),
                        CommonUtils.dp2px(container.getContext(), 10));
                backView.setPadding(CommonUtils.dp2px(container.getContext(), 10),
                        CommonUtils.dp2px(container.getContext(), 10), CommonUtils.dp2px(container.getContext(), 10),
                        CommonUtils.dp2px(container.getContext(), 10));
                backView.setLayoutParams(lpBottomInParent);
                backView.setBackgroundResource(R.drawable.gray_bg);
                backView.setImageResource(mBackImageRes);
            }
//            itemView.addView(backView);

            if (saveView == null) {
                saveView = new ImageView(container.getContext());
                saveView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
                LayoutParams lpBottomInParent = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                lpBottomInParent.gravity = Gravity.BOTTOM | Gravity.END;
                lpBottomInParent.height = CommonUtils.dp2px(container.getContext(), 48);
                lpBottomInParent.width = CommonUtils.dp2px(container.getContext(), 48);
                lpBottomInParent.setMargins(CommonUtils.dp2px(container.getContext(), 10),
                        CommonUtils.dp2px(container.getContext(), 24), CommonUtils.dp2px(container.getContext(), 10),
                        CommonUtils.dp2px(container.getContext(), 24));
//                saveView.setPadding(CommonUtils.dp2px(container.getContext(), 10),
//                        CommonUtils.dp2px(container.getContext(), 10), CommonUtils.dp2px(container.getContext(), 10),
//                        CommonUtils.dp2px(container.getContext(), 10));
                saveView.setLayoutParams(lpBottomInParent);
                saveView.setBackgroundResource(R.drawable.gray_bg);
                saveView.setImageResource(mSaveImageRes);
            }
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        mWidth = w;
        mHeight = h;
        System.out.println("====zhq====>mWidth<"+mWidth);
        if (!isInitLayout) {
            isInitLayout = true;
