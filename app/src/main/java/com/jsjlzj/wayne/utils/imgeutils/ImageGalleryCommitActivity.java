    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_commit:
                ...
                String id = SPUtil.getString(getApplicationContext(), MyConstants.LOGINID, "");
                Log.e("zhq", id + "----" + file.getName() + "----" + file);
                OkHttpUtils.post().url(ConstantsUrl.URL_XIUGAI_IMAGE)
                        .addParams("id", id)
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onError(Call call, Exception e, int id) {
                                LogUtil.i("xiasoli", "上传图片的错误码" + e.getMessage());
                                Toast.makeText(ImageGalleryCommitActivity.this, "修改失败!", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }

                            @Override
                            public void onResponse(String response, int id) {
                                LogUtil.i("xiaoli", "fanhuima" + response);
