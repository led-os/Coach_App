...
/**
  ...
  * @CreateDate:
  */
public class SearchFindStoreActivity extends MVPBaseActivity<HomeView, HomePresenter> implements HomeView , XRecyclerView.LoadingListener {
    ...
    public static void go2this(Context context) {
        context.startActivity(new Intent(context, SearchFindStoreActivity.class));
    }

    @Override
    protected int getLayoutResId() {
        return R.layout.activity_search_find_store;
    }
    ...
    private void initSearchBar() {
        mSearchBar.setOnEditTextChangeListener(new SearchBarView.EditTextCallback() {
            ...
            public void onClickSoftWare(String str) {
                ...
                KeyboardUtil.closeKeyboard(tvBusiness, SearchFindStoreActivity.this);
                loadData(str,true);
            }
        });
    }
    ...
    private void loadData(String searchKey,boolean isRefresh){
        ...
        if(!TextUtils.isEmpty(searchKey)){
            map.put(HttpConstant.KEY_WORD, searchKey);
        }
