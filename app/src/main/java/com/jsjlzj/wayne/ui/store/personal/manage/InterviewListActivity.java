 ...
 * 面试日程
 */
public class InterviewListActivity extends MVPBaseActivity<TalentTabFragmentView, TalentTabFragmentPresenter> implements TalentTabFragmentView {
    ...
    private void getInfo(){
        ...
        presenter.getInterViewStore(map);
...
//        recyclerView.addItemDecoration(new RecycleViewDivider(getContext(), LinearLayoutManager.HORIZONTAL));
            ...
            public void onUpdate(BaseAdapterHelper helper, final MdlInterView.DataBean.ResultBean item, int position) {
                ...
                helper.setOnClickListener(R.id.llItem, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        InterviewDetailActivity.go2this(InterviewListActivity.this,item.getId(),1);
                    }
                });
            }
        };
    ...
    public void showResultgetInterViewStore(MdlBaseHttpResp<MdlInterView> resp){
