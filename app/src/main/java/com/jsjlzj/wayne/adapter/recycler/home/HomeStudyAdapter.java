...
public class HomeStudyAdapter extends RecyclerView.Adapter<HomeStudyAdapter.ViewHolder> {
    ...
    public HomeStudyAdapter(Context context, List<String> list) {
    ...
    @NonNull
    @Override
    public HomeStudyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_home_study, parent, false);
        return new HomeStudyAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeStudyAdapter.ViewHolder holder, int position) {
