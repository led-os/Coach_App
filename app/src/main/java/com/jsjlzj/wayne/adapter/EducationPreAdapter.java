 ...
 */
public class EducationPreAdapter extends BaseAdapter {
    private List<MdlDetailT.DataBean.EducationExperienceListBean> list;
    private Context mContext;
    private LayoutInflater inflater;

    public EducationPreAdapter(Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvEducationTime.setText(list.get(position).getStartDate() + "-" + list.get(position).getEndDate());
        viewHolder.tvEducationMajor.setText(list.get(position).getEducationLevel()+"  "+list.get(position).getMajor());
