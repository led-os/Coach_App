...
public class MdlTrainerDetail {
    ...
    public static class DataBean {
        ...
        private List<WorkHopeListBean> workHope;
        private boolean isLike;
        private String yunXinAccount;

        public List<WorkHopeListBean> getWorkHope() {
            return workHope;
        }

        public void setWorkHope(List<WorkHopeListBean> workHope) {
