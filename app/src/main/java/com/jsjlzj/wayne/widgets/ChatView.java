...
public class ChatView extends RelativeLayout {
    ...
    public ChatView(Fragment activity) {
        super(activity.getContext());
        View view = LayoutInflater.from(activity.getContext()).inflate(R.layout.view_chart, this);
