package com.jsjlzj.wayne.widgets.wheel;
...
import com.jsjlzj.wayne.widgets.wheel.listens.OnWheelClickedListener;
...
//		canvas.translate(PADDING, -top + scrollingOffset);
	...
	private boolean addViewItem(int index, boolean first) {
		...
		if (view != null) {
			...
			if(index==currentItem){
				v.setTextColor(Color.parseColor("#FF333333"));
				...
				if(index==currentItem-1 || index == currentItem+1){
					v.setTextColor(Color.parseColor("#FF494949"));
