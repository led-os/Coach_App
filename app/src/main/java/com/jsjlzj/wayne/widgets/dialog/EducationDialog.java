...
public class EducationDialog extends AlertDialog implements View.OnClickListener {
    ...
    public EducationDialog(@NonNull Activity context, ClickListener listener,String[] datas) {
