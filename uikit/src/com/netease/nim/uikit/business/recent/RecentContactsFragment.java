...
public class RecentContactsFragment extends TFragment {
    protected boolean isTrainer;//是否为教练
    ...
    private void initMessageList() {
        ...
        // adapter
        adapter = new RecentContactAdapter(recyclerView, items, isTrainer);
        initCallBack();
...
//                } else
            ...
            public String getDigestOfAttachment(RecentContact recentContact, MsgAttachment attachment) {
                ...
                Log.d("uiinitCallBack", "getDigestOfAttachment: "+recentContact+"  "+attachment);
                return null;
            }
            ...
            public String getDigestOfTipMsg(RecentContact recent) {
                ...
                Log.d("uiinitCallBack", "getDigestOfAttachment: "+recent);
                return null;
            }
        };
    }
