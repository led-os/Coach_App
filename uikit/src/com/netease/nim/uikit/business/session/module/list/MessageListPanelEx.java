...
public class MessageListPanelEx {
    ...
    public MessageListPanelEx(Container container, View rootView, IMMessage anchor, boolean recordOnly, boolean remote, MyMsgListener msgListener) {
        this.container = container;
        this.rootView = rootView;
        this.recordOnly = recordOnly;
        this.remote = remote;
    ...
    private void initListView(IMMessage anchor) {
        ...
        // adapter
        items = new ArrayList<>();
        if (adapter == null) adapter = new MsgAdapter(messageListView, items, container);
        adapter.setMsgListener(msgListener);
...
//            MessageLoader loader = new MessageLoader(message, true);
//            adapter.setOnFetchMoreListener(loader);
//            adapter.setOnLoadMoreListener(loader);
//        }
