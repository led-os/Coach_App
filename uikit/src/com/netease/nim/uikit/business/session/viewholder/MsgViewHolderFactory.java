...
public class MsgViewHolderFactory {
    ...
    public static List<Class<? extends MsgViewHolderBase>> getAllViewHolders() {
        ...
        list.addAll(getOtherViewHolders());
        return list;
    }
    public static List<Class<? extends MsgViewHolderBase>> getOtherViewHolders() {
        List<Class<? extends MsgViewHolderBase>> list = new ArrayList<>();
    ...
    public static HashMap<Class<? extends MsgAttachment>, Class<? extends MsgViewHolderBase>> getViewHolders() {
        return viewHolders;
    }
}
